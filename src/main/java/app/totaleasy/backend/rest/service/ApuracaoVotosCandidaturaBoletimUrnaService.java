...
public class ApuracaoVotosCandidaturaBoletimUrnaService {
    ...
    public ApuracaoVotosCandidaturaBoletimUrna findById(ApuracaoVotosCandidaturaBoletimUrnaIdDTO id) {
        return this.apuracaoVotosCandidaturaBoletimUrnaRepository
            ...
            .orElseThrow(() -> new EntidadeNaoExisteException(
                String.format("Não foi encontrada nenhuma apuração de votos de candidatura por boletim de urna identificada por %s.", id)
            ));
    }
    ...
    public void deleteById(ApuracaoVotosCandidaturaBoletimUrnaIdDTO id) {
        ...
        if (!this.apuracaoVotosCandidaturaBoletimUrnaRepository.(
            ...
            throw new EntidadeNaoExisteException(String.format("Não foi encontrada nenhuma apuração de votos de candidatura por boletim de urna identificada por %s.", id));
        }
