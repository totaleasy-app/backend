...
public class ErrorHandler {
    ...
    public ResponseEntity<Object> handleEntidadeNaoEncontradaException(
        EntidadeNaoExisteException entidadeNaoEncontradaException
    ) {
        return this.handleError(
    ...
    public ResponseEntity<Object> handleTokenExpiradoException(
        TokenExpiradoException tokenExpiradoException
    ) {
        return this.handleError(
            tokenExpiradoException.getMessage(),
